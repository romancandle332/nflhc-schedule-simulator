...
while year < loop:
    ...
    while value_nolossofgenerality < len(database):
        ...
        d = database[value_nolossofgenerality][1]
        macro_database[value_nolossofgenerality][1] += d
        value_nolossofgenerality += 1
    ...
    while x < 6:
        ...
        if not AFC_tiebreaker:
            ...
            if AFC == 0:
                ...
                macro_database[AFC_tiebreaker[0]][3] += 1
            elif AFC == 1:
            ...
            if database[AFC_tiebreaker[1]][0] in database[AFC_tiebreaker[0]][9]:
                ...
                if AFC == 0:
                    ...
                    macro_database[AFC_tiebreaker[1]][3] += 1
                elif AFC == 1:
        ...
        if not NFC_tiebreaker:
            ...
            if NFC == 0:
                ...
                macro_database[NFC_tiebreaker[0]][3] += 1
            elif NFC == 1:
            ...
            if database[NFC_tiebreaker[1]][0] in database[NFC_tiebreaker[0]][9]:
                ...
                if NFC == 0:
                    ...
                    macro_database[NFC_tiebreaker[1]][3] += 1
                elif NFC == 1:
